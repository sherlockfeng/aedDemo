...
// 高德开发者key
let key = 'f7a62133a720ff24bbe67fe29d989a70';
let myAmapFun = new amapFile.AMapWX({ key });

let QQMapWX = require('./qqmap-wx-jssdk');
let keyQQ = 'UTBBZ-ORXCK-V2PJB-AVUAS-QSBV2-ABBCO'
...
class Amap {
   ...
   */
   ...
   static getRegeoQQ(latitude,longitude) {
     return new Promise((resolve, reject) => qqmapsdk.reverseGeocoder({ location: {
      latitude,
      longitude
   ...
   */
  static getRoute(origin, destination, type, city='上海') {
